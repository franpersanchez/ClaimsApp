...
namespace ClaimsApp.Controllers
{
    public class VehiclesController : Controller
    {
        ...
        public VehiclesController(ClaimsAppContext context)
        {
            _context = context;
        }
        ...
        {
            var claimsAppContext = _context.Vehicle.Include(v => v.Owner);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ClaimsAppContext.Vehicle'  is null.");
            }
            var vehicle = await _context.Vehicle.FindAsync(id);
            if (vehicle != null)
            {
